...
const TV = () => {
  ...
  const editTv = location.state?.tv;
  useEffect(() => {
    if (editTv) {
      setFile(editTv.file);
      setTitle(editTv.title);
      setLanguage(editTv.language);
      setRate(editTv.rate);
      setGenre(editTv.genre);
      setDate(editTv.date);
      setDuration(
        typeof editTv.duration === "object"
          ? `${editTv.duration.hours}h ${editTv.duration.minutes}m`
          : editTv.duration
      );
      setDescription(editTv.description);
    }
  }, [editTv]);
  ...
  function validateFields() {
    ...
    if (!file) newErrors.file = "Show poster is required";
    if (!title.trim()) newErrors.title = "Show title is required";
  ...
  function handleAddTodo() {
    ...
    let updatedshow = [...show, newShow];
    setshow(updatedshow);
    // localStorage
    localStorage.setItem("newShow", JSON.stringify(updatedshow));
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
            Expand your TV show library by adding new shows with all the details
          </p>
        </div>
      </section>
          ...
          <form className="space-y-8">
                  ...
                  {file ? (
                    ...
                    <>
                      ...
                      <p className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                        Click to upload TV Show poster or drag and drop
                      </p>
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                placeholder="Enter TV Show description, plot summary, or synopsis..."
                className={`w-full px-6 py-4 bg-gray-800/50 border ${
